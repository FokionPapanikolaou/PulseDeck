# PulseDeck — Store Listing (English)

## App name
PulseDeck — System Monitor & PC Tools

## Subtitle / Short description (max 200 chars)
Live CPU, GPU, RAM, network & weather on your taskbar — plus 24 Windows tools, a DNS speed test and a live bottleneck check. Free, no ads.

## Description (max 10,000 chars)
**PulseDeck** turns your Windows taskbar into a live system dashboard — and a handy toolbox. Tiny, transparent, always visible, never in the way.

See your **CPU, GPU, RAM, Network** speed and even the **weather** at a glance, without ever opening Task Manager. Then open the menu for a full **System** report, a **bottleneck** check, a one-tap **Tools** drawer and a built-in **DNS speed test**.

### ✨ Live on your taskbar
• **CPU** — usage % and live clock speed (GHz)
• **RAM** — used / total GB, plus % load
• **GPU** — usage % and VRAM used / total *(via Windows counters — no extra drivers)*
• **Network** — real-time upload ▲ / download ▼ (MB/s or Mbps)
• **Disk** — read / write speed and per-drive space %
• **Battery** — % with charging indicator (laptops)
• **Weather** — temperature with a 3-day forecast on hover
• Show **icons or text** (CPU/GPU/RAM…) — your choice
...
### 🎨 Make it yours
• Sit **on** the taskbar or float **just above** it — one toggle
• Drag anywhere; lock its position
• **10 color themes** including gaming styles (Neon, Cyber, Inferno, Plasma, animated RGB)
• 3 sizes, adjustable transparency and refresh rate
• Resizable settings window

### 🌐 8 languages
English · Ελληνικά · Español · Deutsch · Français · Italiano · Português · Русский — auto-detected.
...
PulseDeck is **free**. If it earns a spot on your taskbar, a Donate link in the tray menu (PayPal / Revolut) keeps it growing. A quick ⭐ review helps even more.
