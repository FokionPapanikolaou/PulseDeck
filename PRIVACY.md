...
PulseBar ("the app") is a desktop system-monitor for Windows 10/11. This
...
## 1. What we collect
**Nothing.** PulseBar does not have any servers, accounts, sign-in, telemetry,
crash reporting, advertising or analytics. We never see how you use the app.

## 2. What the app stores on your PC
PulseBar saves a single configuration file (`config.json`) with your
...
On launch, PulseBar may contact the public **GitHub Releases API**
...
## 6. Children
PulseBar is a general-purpose utility and is not directed at children. We do
...
PulseBar → Uninstall), which also removes the configuration file.

## 8. Changes to this policy
If this policy changes, the new version will be published in the project
repository at `github.com/FokionPapanikolaou/PulseBar`. The "Effective date"
above will be updated accordingly.

## 9. Contact
Questions about this policy: open an issue at
**https://github.com/FokionPapanikolaou/PulseBar/issues**
